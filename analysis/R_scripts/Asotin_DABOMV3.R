...
ACB_dirch_vec = rep(1, n_branch_ACB)
ASOTIC_dirch_vec = rep(1, n_branch_ASOTIC)
...
file_nm = "model_files/AsotinDABOM.jags"
...
start.time<-Sys.time()
out<- jags.parallel(data=jags.data, model.file=file_nm,#inits=inits,
